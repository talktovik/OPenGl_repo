//// Since here we defind the glfwWindowHint so we opengl legecy systems will not work
...
//
//
//	// Because of such defination the legecy functions won't work.
//	//like glbegin, glend and other stuff as well.
